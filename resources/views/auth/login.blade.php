    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-body" style="border-color: darkorange">
                <div class="card-header" style="background-color: darkorange; color: white">{{ __('Đăng nhập') }}</div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link" href="{{ route('password.request') }}" style="color: darkorange">
                                        {{ __('Quên mật khẩu?') }}
                                    </a>
                                @endif
                            </div>
